...
mixin _$UserListResponse {
 ...
 List<User> get users; int get totalCount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserListResponse&&const DeepCollectionEquality().equals(other.users, users)&&(identical(other.totalCount, totalCount) || other.totalCount == totalCount));
}
...
@override
String toString() {
  return 'UserListResponse(users: $users, totalCount: $totalCount)';
}
...
@useResult
$Res call({
 List<User> users, int totalCount
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? users = null,Object? totalCount = null,}) {
  return _then(UserListResponse(
users: null == users ? _self.users : users // ignore: cast_nullable_to_non_nullable
as List<User>,totalCount: null == totalCount ? _self.totalCount : totalCount // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<User> users,  int totalCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserListResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<User> users,  int totalCount)  $default,) {final _that = this;
switch (_that) {
case _UserListResponse():
return $default(_that.users,_that.totalCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<User> users,  int totalCount)?  $default,) {final _that = this;
switch (_that) {
case _UserListResponse() when $default != null:
return $default(_that.users,_that.totalCount);case _:
  return null;
...
class _UserListResponse implements UserListResponse {
  const _UserListResponse({required  List<User> users, this.totalCount = 0}): _users = users;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserListResponse&&const DeepCollectionEquality().equals(other._users, _users)&&(identical(other.totalCount, totalCount) || other.totalCount == totalCount));
}
