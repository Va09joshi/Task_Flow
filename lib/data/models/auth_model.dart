...
abstract class AuthMockData with _$AuthMockData {
  const factory AuthMockData({
    @JsonKey(name: 'test_credentials') required List<AuthCredentials> testCredentials,
    @JsonKey(name: 'mock_login_response') required AuthResponse mockLoginResponse,
  }) = _AuthMockData;

  factory AuthMockData.fromJson(Map<String, dynamic> json) => _$AuthMockDataFromJson(json);
}
